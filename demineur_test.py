...
Pour l'implémentation de place_mines, le test devrait fonctionner si vous implémentez la pose des mines de la façon suivante:
  - générez une nouvelle position aléatoire
  - si la position générée est cohérente et libre, ajoutez la à la liste de mines posées
  - si la position ne respecte pas les consignes ou est déjà prise, générer de nouvelles coordonnées jusqu'à obtenir un position valide.
"""
